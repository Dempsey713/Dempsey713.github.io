...
===save_or_sunder_ending
You run to your partner, calling out their name. You grab their shoulders and try to get them to respond with all you've got. You hear a faint whisper of a breath coming out of them.
...
{
    -n==1: 
        You start panicking. "This can't be real", you think to yourself.
    -angry:
        You walk towards your house.
    -else:
        You immediately start running to your house.
}
{ shuffle:
	- 	You break through the window and run to your bedroom. 
	    The room is empty. A strange feeling of comfort overtakes you temporarily, but then you hear the water running. 
	...
	- 	You break through the window and run to your bedroom. 
	    The room is empty. A strange feeling of comfort overtakes you temporarily, but then you hear the water running. 
	    You run to the bathroom.
	    It is pitch black and there is a smell of burnt flesh in the air. 
    	    + [SWITCH ON THE LIGHTS]
    	    You turn on the lights
    	    # LIGHTS: on
    	    .
...
{n==1: You start hyperventilating and think of how things were similar to your dream. You remember how you jumped into the water and then woke up in your bed having gone back in time. You start considering the possibility of that being real.}
